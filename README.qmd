...
I want to do a project related to Fantasy Sports, specifically Fantasy Football. I think it would be cool to do something related to DraftKings Sunday Millionaire contest to try and see if there is some correlation between all the winners and where they spent up or spent down at a position. If I can't get that data I think something to do with draft position/draft strategy in a stamdard Fantasy Football League would also be interesting. 
